...
public class RuleSimulator {
    ...
    public static RuleConditions getRule(){
        ...
        hashMap1.put("p2","v1");
        EventCondition event1 = new EventCondition("K",hashMap1,0,-1,-1,"");
        ...
        EventCondition event3 = new EventCondition(eventId, hashMap3, 1,startTime,endTime,sql);
        ...
        m1.put("p1","v1");
        EventCondition ev1 = new EventCondition(eventId1, m1, -1, startTime2, endTime2, null);

        String eventId2 = "B";
        HashMap<String, String> m2 = new HashMap<>();
        m2.put("p2","v2");
        EventCondition ev2 = new EventCondition(eventId2, m2, -1, startTime2, endTime2, null);

        String eventId3 = "C";
        HashMap<String, String> m3 = new HashMap<>();
        m3.put("p3","v3");
        EventCondition ev3 = new EventCondition(eventId3, m3, -1, startTime2, endTime2, null);
