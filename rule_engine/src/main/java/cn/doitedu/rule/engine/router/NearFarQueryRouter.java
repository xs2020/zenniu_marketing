...
import cn.doitedu.rule.engine.Utils.SegmentQueryUtil;
...
import cn.doitedu.rule.engine.queryservice.StateQueryIml;
...
public class NearFarQueryRouter {
                ...
                //跨界查询
                    ...
                    //跨界查询指定事件的最大匹配步骤
                        ...
                        if(countInClik < actionSequenceCondition.getEventSequence().size()){
                            ...
                            List<EventCondition> eventSequence = actionSequenceCondition.getEventSequence();
                            List<EventCondition> trimedEventSequence = eventSequence.subList(countInClik, eventSequence.size());
     ...
     */
    private long stateQueryEventCount(ListState<EventBean> eventBeansState, EventCondition actionCountCondition, long queryStart, long queryEnd) throws Exception {
        long stateCount = 0;
